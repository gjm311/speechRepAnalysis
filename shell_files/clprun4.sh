...
python3 clpDnnEval.py CAE wvlt "/./clpSpanish/speech/"
python3 clpDnnEval.py CAE broadband "/./clpSpanish/speech/"
python3 clpDnnEval.py CAE narrowband "/./clpSpanish/speech/"
python3 clpDnnEval.py CAE early_fuse "/./clpSpanish/speech/"
python3 clpDnnEval.py CAE mc_fuse "/./clpSpanish/speech/"
